...
if (typeof options_style_masthead == "undefined") {
...
function add_masthead_item(section_page_id, uniqid, identifier = 0, data = "", data_sub = "") {
    ...
    var v_page_element_title_style = '';
    var v_page_element_subtitle = '';
    var v_page_element_subtitle_style = '';
    ...
    var v_page_element_image_link_type = '';
    var v_page_element_image_link_internal = '';
    var v_page_element_image_link_external = '';
    var v_page_element_image_link_target = '';
    ...
    if (data != '') {
        ...
        v_page_element_title_style = data.v_page_element_title_style;
        v_page_element_subtitle = decodeURI(data.v_page_element_subtitle);
        v_page_element_subtitle_style = data.v_page_element_subtitle_style;
        ...
        v_page_element_image_link_type = data.v_page_element_image_link_type;
        v_page_element_image_link_internal = data.v_page_element_image_link_internal;
        v_page_element_image_link_external = data.v_page_element_image_link_external;
        v_page_element_image_link_target = data.v_page_element_image_link_target;
        is_required = '';
    ...
    html += '<div class="panel panel-pagebuilder-masthead" id="pagebuilder_masthead_page_' + identifier + '">';
        ...
        html += '<div id="collapse_section_' + identifier + '" class="panel-collapse collapse" role="tabpanel">';
            html += '<div class="panel-body">';
                ...
                html += '<div class="form-group">';
                    ...
                    html += '<div class="col-md-6 col-sm-6 col-xs-12">';
                        ...
                        html += '<br><span class="infotext">Recommended image size is 1920 x 720 px (Max 2MB). Use images with same height if you have multiple images.</span>';
                    html += '</div>';
                html += '</div>';
                ...
                html += '<div class="form-group">';
                    ...
                    html += '<div class="col-md-6 col-sm-6 col-xs-12">';
                        ...
                        html += '<br><span class="infotext">Recommended image size is 800 x 800 px (Max 2MB). Use images with same height if you have multiple images.</span>';
                    html += '</div>';
                html += '</div>';
                ...
                // ON-IMAGE TITLE - STYLE
                html += '<div class="form-group">';
                    html += '<label class="control-label col-md-3 col-sm-3 col-xs-12">Title Color</label>';
                    html += '<div class="col-md-6 col-sm-6 col-xs-12">';
                        html += '<select name="v_page_element_title_style[' + section_page_id + '][' + uniqid + '][' + identifier + ']" class="form-control col-md-7 col-xs-12">';
                            $.each(options_style_masthead, function(index_item, value_item) {
                                selected_status = '';
                                if (value_item == v_page_element_title_style) {
                                    selected_status = 'selected';
                                }
                ...
                // ON-IMAGE SUBTITLE - STYLE
                html += '<div class="form-group">';
                    html += '<label class="control-label col-md-3 col-sm-3 col-xs-12">Subtitle Color</label>';
                    html += '<div class="col-md-6 col-sm-6 col-xs-12">';
                        html += '<select name="v_page_element_subtitle_style[' + section_page_id + '][' + uniqid + '][' + identifier + ']" class="form-control col-md-7 col-xs-12">';
                            $.each(options_style_masthead, function(index_item, value_item) {
                                selected_status = '';
                                if (value_item == v_page_element_subtitle_style) {
                                    selected_status = 'selected';
                                }
                                html += '<option value="'+value_item+'" '+selected_status+'>'+value_item+'</option>';
                            });
                ...
                // IMAGE - LINK TYPE
                html += '<div class="form-group">';
                html += '<label class="control-label col-md-3 col-sm-3 col-xs-12">Image - Link Type</label>';
                html += '<div class="col-md-6 col-sm-6 col-xs-12">';
                    html += '<select name="v_page_element_image_link_type[' + section_page_id + '][' + uniqid + '][' + identifier + ']" class="form-control col-md-7 col-xs-12" onchange="show_input_link(this.value, \'' + uniqid + identifier + '\')">';
                        ...
                        $.each(options_link_type, function(index_link, value_link) {
                            selected_status = '';
                            if (value_link.opt_value == v_page_element_image_link_type) {
                                selected_status = 'selected';
                            }
            ...
            // IMAGE - LINK (INTERNAL)
            html += '<div class="form-group" id="pagebuilder-link-internal-' + uniqid + identifier + '" style="display:none;">';
                html += '<label class="control-label col-md-3 col-sm-3 col-xs-12">Image - Link (Internal)</label>';
                html += '<div class="col-md-6 col-sm-6 col-xs-12">';
                    html += '<div class="input-group">';
                        html += '<span class="input-group-addon">' + pagebuilder_url + '/</span>';
                        html += '<input type="text" autocomplete="off" value="'+v_page_element_image_link_internal+'" name="v_page_element_image_link_internal[' + section_page_id + '][' + uniqid + '][' + identifier + ']" class="form-control col-md-7 col-xs-12">';
                    html += '</div>';
                html += '</div>';
            html += '</div>';
            ...
            html += '<div class="form-group" id="pagebuilder-link-external-' + uniqid + identifier + '" style="display:none;">';
                html += '<label class="control-label col-md-3 col-sm-3 col-xs-12">Image - Link (External)</label>';
                html += '<div class="col-md-6 col-sm-6 col-xs-12">';
                    html += '<input type="text" autocomplete="off" value="'+v_page_element_image_link_external+'" name="v_page_element_image_link_external[' + section_page_id + '][' + uniqid + '][' + identifier + ']" class="form-control col-md-7 col-xs-12" placeholder="(sample: https://domain.com/promo-september)">';
                html += '</div>';
            html += '</div>';

            // IMAGE - LINK TARGET
            html += '<div class="form-group pagebuilder-link-' + uniqid + identifier + '" style="display:none;">';
                html += '<label class="control-label col-md-3 col-sm-3 col-xs-12">Image - Link Target</label>';
                html += '<div class="col-md-6 col-sm-6 col-xs-12">';
                    html += '<select name="v_page_element_image_link_target[' + section_page_id + '][' + uniqid + '][' + identifier + ']" class="form-control col-md-7 col-xs-12">';
                        ...
                        $.each(options_link_target, function(index_link, value_link) {
                            selected_status = '';
                            if (value_link.opt_value == v_page_element_image_link_target) {
                                selected_status = 'selected';
                            }
                            html += '<option value="'+value_link.opt_value+'" '+selected_status+'>'+value_link.opt_text+'</option>';
                        });
    ...
    if (data != '') {
        show_input_link(v_page_element_image_link_type, (uniqid + identifier));
    }
}
            ...
            html += '<div class="panel-body">';
                ...
                html += '<div class="form-group">';
                    ...
                    html += '<div class="col-md-6 col-sm-6 col-xs-12">';
                        ...
                        html += '<input type="file" name="v_page_element_image[' + section_page_id + '][' + uniqid + '][' + identifier + ']" '+is_required+' class="form-control col-md-7 col-xs-12" accept=".jpg, .jpeg, .png" onchange="display_img_input(this, \'before\');" style="margin-top:5px">';
                        html += '<input type="hidden" name="v_page_element_imagex[' + section_page_id + '][' + uniqid + '][' + identifier + ']" value="'+v_page_element_imagex+'">';
                        html += '<br><span class="infotext">Recommended image size is 960 x 365 px for Slideshow and 960 x 640 px for Carousel (Max 2MB). Use images with same dimensions if you have multiple images.</span>';
                    html += '</div>';
                html += '</div>';
            ...
            html += '<div class="panel-body">';
                ...
                html += '<div class="form-group page-element-imagetextbutton-'+uniqid+'-'+i+'">';
                    ...
                    html += '<div class="col-md-6 col-sm-6 col-xs-12">';
                        ...
                        html += '<br><span class="infotext">It is recommended to resize your image to 800 px width (Max 2MB) to ensure best quality with minimum loading time.</span>';
                    html += '</div>';
                html += '</div>';
