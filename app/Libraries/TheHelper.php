...
class TheHelper
{
    ...
    public static function generate_slug($string, $ideal = true)
    {
        ...
        $formatted_string = trim(preg_replace('/[-]+/', ' ', $formatted_string));
    ...
    // echo convert_date_to_indonesian(date('Y-m-d')); => 21 Oktober 2017
    public static function convert_date_to_indonesian($date) 
    {
        ...
        // variabel piece 0 = tanggal
        // variabel piece 1 = bulan
        // variabel piece 2 = tahun
     
        return $piece[2] . ' ' . $month[ (int) $piece[1] ] . ' ' . $piece[0];
    }
