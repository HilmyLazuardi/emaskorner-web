...
class ModuleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.core.module.list');
    }
    ...
    public function get_data(Datatables $datatables, Request $request)
    {
        ...
        return $datatables->eloquent($query)
            ->addColumn('action', function ($data) {
                ...
                $html = '<a href="' . route('admin.module.edit', $object_id) . '" class="btn btn-xs btn-primary" title="' . $wording_edit . '"><i class="fa fa-pencil"></i>&nbsp; ' . $wording_edit . '</a>';

                $wording_delete = ucwords(lang('delete', $this->translations));
                $html .= '<form action="' . route('admin.module.delete') . '" method="POST" onsubmit="return confirm(\'' . lang('Are you sure to delete this #item?', $this->translations, ['#item' => $this->item]) . '\');" style="display: inline"> ' . csrf_field() . ' <input type="hidden" name="id" value="' . $object_id . '">
    ...
    public function create()
    {
        ...
        return view('admin.core.module.form');
    }
    ...
    public function store(Request $request)
    {
        ...
        // LARAVEL VALIDATION
        $validation = [
            'name' => 'required|unique:' . $module_table . ',name'
        ];
        $message = [
        ...
        // SET REDIRECT URL
        $redirect_url = 'admin.module';
        if ($request->stay_on_page) {
            $redirect_url = 'admin.module.create';
        }
    ...
    public function edit($id, Request $request)
    {
        ...
        return view('admin.core.module.form', compact('data', 'raw_id'));
    }
    ...
    public function update($id, Request $request)
    {
        ...
        if ($request->stay_on_page) {
            return redirect()
                ->route('admin.module.edit', $raw_id)
    ...
    public function deleted_data()
    {
        ...
        return view('admin.core.module.list', compact('deleted_data'));
    }
    ...
    public function get_deleted_data(Datatables $datatables, Request $request)
    {
        ...
        return $datatables->eloquent($query)
            ->addColumn('action', function ($data) {
                ...
                return '<form action="' . route('admin.module.restore') . '" method="POST" onsubmit="return confirm(\'' . lang('Are you sure to restore this #item?', $this->translations, ['#item' => $this->item]) . '\');" style="display: inline"> ' . csrf_field() . ' <input type="hidden" name="id" value="' . $object_id . '">
    ...
    public function restore(Request $request)
    {
        ...
        // GET DATA BY ID
        $data = module::onlyTrashed()->find($id);
        ...
        if ($data->restore()) {
            ...
            # SUCCESS
            return redirect()
                ->route('admin.module.deleted_data')
