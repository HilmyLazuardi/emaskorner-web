        ...
        <div class="section_product_list search_result">
            @if (!is_null($keyword))
                <div class="row_clear container search_text">
                    {{ $count_products }} hasil pencarian untuk "{{ $keyword }}"
                </div>
            @endif
        ...
        <div class="popup_box">
            ...
            <form action="{{ route('web.product.filter') }}">
                ...
                <div class="filter_box">
                    <h5>Urutkan</h5>
                    <ul>
                        <li><input type="radio" name="orderby" value="highestprice"><span>Harga Tertinggi</span></li>
                        <li><input type="radio" name="orderby" value="lowestprice"><span>Harga Terendah</span></li>
                        <li><input type="radio" name="orderby" value="newestproduct"><span>Produk Terbaru</span></li>
                        <li><input type="radio" name="orderby" value="oldestproduct"><span>Produk Terlama</span></li>
                        <li><input type="radio" name="orderby" value="bestseller"><span>Produk Terlaris</span></li>
                    </ul>
                </div>
                <div class="filter_box">
                    <h5>Rentang Harga</h5>
                    <div class="form_filter">
                        <input type="text" name="price_min" class="form-control input-number" min="0" placeholder="Minimum">
                        <span></span>
                        <input type="text" name="price_max" class="form-control input-number" min="0" placeholder="Maksimum">
                    </div>
                </div>
                {{-- <div class="filter_box">
                    <h5>Kategori</h5>
