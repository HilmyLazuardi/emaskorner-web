<!-- .bs-modal-sm -->
<div class="modal fade bs-modal-sm" tabindex="-1" role="dialog" aria-hidden="true" @if(View::hasSection('small_modal_id')) id="@yield('small_modal_id')" @endif>
    <div class="modal-dialog modal-sm">
        @if(View::hasSection('small_modal_form'))
            <form method="@yield('small_modal_method')" action="@yield('small_modal_url')" enctype="multipart/form-data" @if(View::hasSection('small_modal_form_validation')) onsubmit="@yield('small_modal_form_validation')" @endif>
            @csrf
        @endif
