		...
		<tbody style="background: #D3A381;border-radius: 10px;">
			<tr>
				<td style="color:#3A3A3A;background:#D3A381;font-family: Arial, Helvetica, sans-serif;padding:20px 40px 20px 40px;text-align: center;border-top: 1px solid #959595;">
					Halo <strong>{!! $data['name'] !!}</strong>,<br><br>Password kamu sudah diganti yang baru.<br><br>Tidak merasa mengubahnya? Segera reset password kamu dengan klik "Lupa Password" saat akan login dan hubungi kami di <a style="color:#0C6663;" href="mailto:help@emaskorner.com">help@emaskorner.com.</a>
				</td>
			</tr>
		</tbody>
		<tfoot>
