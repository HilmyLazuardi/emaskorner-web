		...
		<tbody style="background: #D3A381;border-radius: 10px;">
			<tr>
				<td style="color:#3A3A3A;background:#D3A381;font-family: Arial, Helvetica, sans-serif;padding:20px 40px 20px 40px;text-align: center;border-top: 1px solid #959595;">
					<h2 style="color:#3A3A3A;font-size: 16px;">Selangkah lagi untuk jadi bagian dari EmasKorner!</h2>
				</td>
			</tr>
			<tr>
				<td style="padding:0 40px 20px 40px;color:#3A3A3A;text-align: center;">
					...
					<a href="{!! $data['link'] !!}" style="background: #0C6663;color:#FFF;padding:10px 20px;text-decoration: none;min-width: 200px;display: inline-block;">Lihat Perjanjian</a>
				</td>
			</tr>
		</tbody>
		<tfoot>
