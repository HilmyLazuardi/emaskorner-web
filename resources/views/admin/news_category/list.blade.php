...
@php
    $module             = ucwords(lang('news category', $translations));
    $pagetitle          = $module;
    ...
    <div class="">
        ...
        <div class="page-title">
            ...
            @if (isset($deleted_data))
                <div class="title_right">
                    <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right">
                        <a href="{{ route('admin.news_category') }}" class="btn btn-round btn-primary" style="float: right;">
            ...
            @else
                <div class="title_right">
                    <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right">
                        <a href="{{ route('admin.news_category.deleted_data') }}" class="btn btn-round btn-danger" style="float: right; margin-bottom: 5px;" data-toggle="tooltip" title="{{ ucwords(lang('view deleted items', $translations)) }}">
                            <i class="fa fa-trash"></i>
                        </a>
                        <a href="{{ route('admin.news_category.create') }}" class="btn btn-round btn-success" style="float: right;">
    ...
    <script>
        ...
        function refresh_data() {
            ...
            var table = $('#datatables').DataTable({
                ...
                serverSide: true,
                processing: true,
                ajax: "{{ route('admin.news_category.get_data') }}",
                order: [[ 0, 'desc' ]],
                columns: [
                    { data: 'name', name: 'news_categories.name' },
                    { data: 'slug', name: 'news_categories.slug' },
                    { data: 'status', name: 'news_categories.status' },
                    { data: 'created_at', name: 'news_categories.created_at' },
                    { data: 'updated_at', name: 'news_categories.updated_at' },
        ...
        function refresh_deleted_data() {
            ...
            var table = $('#datatables-deleted').DataTable({
                ...
                serverSide: true,
                processing: true,
                ajax: "{{ route('admin.news_category.get_deleted_data') }}",
                order: [[ 0, 'asc' ]],
                columns: [
                    { data: 'name', name: 'name' },
                    { data: 'slug', name: 'slug' },
