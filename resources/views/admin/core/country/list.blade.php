...
@php
    $module = ucwords(lang('country', $translations));
    $pagetitle = $module;
    ...
    <div class="">
        ...
        <div class="page-title">
            ...
            @if (isset($deleted_data))
                <div class="title_right">
                    <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right">
                        <a href="{{ route('admin.country') }}" class="btn btn-round btn-primary" style="float: right;">
            ...
            @else
                <div class="title_right">
                    <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right">
                        <a href="{{ route('admin.country.deleted_data') }}" class="btn btn-round btn-danger" style="float: right; margin-bottom: 5px;" data-toggle="tooltip" title="{{ ucwords(lang('view deleted items', $translations)) }}">
                            <i class="fa fa-trash"></i>
                        </a>
                        <a href="{{ route('admin.country.create') }}" class="btn btn-round btn-success" style="float: right;">
                        ...
                        <div class="table-responsive">
                            <table id="datatables" class="table table-striped table-bordered dt-responsive" style="display:none">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>{{ ucwords(lang('country name', $translations)) }}</th>
                                        <th>{{ ucwords(lang('country alias', $translations)) }}</th>
                                        <th>ISO3</th>
                                        <th>{{ ucwords(lang('number code', $translations)) }}</th>
                                        <th>{{ ucwords(lang('country code', $translations)) }}</th>
    ...
    <script>
        ...
        function refresh_data() {
            ...
            var table = $('#datatables').DataTable({
                ...
                serverSide: true,
                processing: true,
                ajax: "{{ route('admin.country.get_data') }}",
                order: [[ 6, 'asc' ]],
                columns: [
                    {data: 'id', name: 'id'},
                    {data: 'country_name', name: 'country_name'},
                    {data: 'country_alias', name: 'country_alias'},
                    {data: 'iso3', name: 'iso3'},
        ...
        function refresh_deleted_data() {
            ...
            var table = $('#datatables-deleted').DataTable({
                ...
                serverSide: true,
                processing: true,
                ajax: "{{ route('admin.country.get_deleted_data') }}",
                order: [[ 0, 'asc' ]],
                columns: [
                    {data: 'id', name: 'id'},
                    {data: 'country_name', name: 'country_name'},
