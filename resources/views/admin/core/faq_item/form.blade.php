...
@php
    ...
    if(isset($data)){
        ...
        $link = route('admin.faq_item.update', [$raw_parent, $raw_id]);
    }else {
        $pagetitle .= ' ('.ucwords(lang('new', $translations)).')';
        $link = route('admin.faq_item.store', [$raw_parent]);
        $data = null;
    }
@endphp
                    ...
                    <div class="x_content">
                        ...
                        <form id="form_data" class="form-horizontal form-label-left" action="{{ $link }}" method="POST" enctype="multipart/form-data">
                            ...
                            @php
                                ...
                                echo set_input_form('textarea', 'text_1', ucwords(lang('question', $translations)), $data, $errors, true, $config);
                                echo set_input_form('textarea', 'text_2', ucwords(lang('answer', $translations)), $data, $errors, true, $config);
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                    ...
                                    <a href="{{ route('admin.faq_item', [$raw_parent]) }}" class="btn btn-default"><i class="fa fa-times"></i>&nbsp; 
                                        @if (isset($data))
                        ...
                        @if (isset($raw_id))
                            <form id="form_delete" action="{{ route('admin.faq.delete', [$raw_id]) }}" method="POST" onsubmit="return confirm('{!! lang('Are you sure to delete this #item?', $translations, ['#item' => 'data']) !!}');" style="display: none">
                                @csrf
