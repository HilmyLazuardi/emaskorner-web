...
@php
    $pagetitle = ucwords(lang('decrypt tool', $translations));
    $link = route('dev.decrypt');
    if (!isset($data)) {
        $data = null;
    }
@endphp
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div class="alert alert-info">
                            ...
                            This tool for decrypt cipher text using <a href="https://github.com/defuse/php-encryption" target="_blank" style="color:white !important; text-decoration: underline !important;">defuse/php-encryption &nbsp;<i class="fa fa-external-link"></i></a>
                        </div>
                        <form id="form_data" class="form-horizontal form-label-left" action="{{ $link }}" method="POST" enctype="multipart/form-data">
                            ...
                            @php
                                ...
                                echo set_input_form('textarea', 'result', ucwords(lang('decrypted string', $translations)), $data, $errors, false, $config);
                            @endphp
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                    ...
                                    <a href="{{ route('dev.decrypt') }}" class="btn btn-warning">
