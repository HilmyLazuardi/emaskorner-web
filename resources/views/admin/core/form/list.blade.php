...
@section('small_modal_title', ucwords(lang('add #item', $translations, ['#item'=>ucwords(lang('form', $translations))])))
@section('small_modal_content')
    <a href="{{ route('admin.form.create', 'quiz') }}" class="btn btn-primary btn-block" ><i class="fa fa-trophy"></i>&nbsp; Quiz</a><br>
    <a href="{{ route('admin.form.create', 'questionnaire') }}" class="btn btn-primary btn-block" ><i class="fa fa-file-text-o"></i>&nbsp; Questionnaire</a><br>
@endsection
...
@php
    $module = ucwords(lang('form', $translations));
    $pagetitle = $module;
    ...
    <div class="">
        ...
        <div class="page-title">
            ...
            @if (isset($deleted_data))
                <div class="title_right">
                    <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right">
                        <a href="{{ route('admin.form') }}" class="btn btn-round btn-primary" style="float: right;">
            ...
            @else
                <div class="title_right">
                    <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right">
                        <a href="{{ route('admin.form.deleted_data') }}" class="btn btn-round btn-danger" style="float: right; margin-bottom: 5px;" data-toggle="tooltip" title="{{ ucwords(lang('view deleted items', $translations)) }}">
                            <i class="fa fa-trash"></i>
                        </a>
                        <span class="btn btn-round btn-success" data-toggle="modal" data-target="#modal_add_item" style="float: right;">
                            ...
                            <table id="datatables" class="table table-striped table-bordered dt-responsive" style="display:none">
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ ucwords(lang('type', $translations)) }}</th>
    ...
    <script>
        ...
        function refresh_data() {
            ...
            var table = $('#datatables').DataTable({
                ...
                serverSide: true,
                processing: true,
                ajax: "{{ route('admin.form.get_data') }}",
                order: [[ 0, 'desc' ]],
                columns: [
                    {data: 'id', name: 'id'},
        ...
        function refresh_deleted_data() {
            ...
            var table = $('#datatables-deleted').DataTable({
                ...
                serverSide: true,
                processing: true,
                ajax: "{{ route('admin.form.get_deleted_data') }}",
                order: [[ 0, 'asc' ]],
                columns: [
                    {data: 'id', name: 'id'},
                    {data: 'title', name: 'title'},
