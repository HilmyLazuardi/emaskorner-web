            ...
            @if (isset($deleted_data))
                <div class="title_right">
                    <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right">
                        <a href="{{ route('admin.product_faq', $raw_product_item_id) }}" class="btn btn-round btn-primary" style="float: right;">
            ...
            @else
                <div class="title_right">
                    <div class="col-md-7 col-sm-7 col-xs-12 form-group pull-right">
                        <a href="{{ route('admin.product_faq.deleted_data', $raw_product_item_id) }}" class="btn btn-round btn-danger" style="float: right; margin-bottom: 5px;" data-toggle="tooltip" title="{{ ucwords(lang('view deleted items', $translations)) }}">
                            <i class="fa fa-trash"></i>
                        </a>
                        <a href="{{ route('admin.product_faq.create', $raw_product_item_id) }}" class="btn btn-round btn-success" style="float: right;">
                    ...
                    <div class="x_content">
                        <div class="table-responsive">
                            <table id="datatables" class="table table-striped table-bordered dt-responsive" style="display:none">
                                <thead>
                                    <tr>
                                        <th>{{ ucwords(lang('question', $translations)) }}</th>
                                        <th>{{ ucwords(lang('answer', $translations)) }}</th>
    ...
    <script>
        ...
        function refresh_data() {
            ...
            var table = $('#datatables').DataTable({
                ...
                serverSide: true,
                processing: true,
                ajax: "{{ route('admin.product_faq.get_data', $raw_product_item_id) }}",
                order: [[ 0, 'asc' ]],
                columns: [
        ...
        function refresh_deleted_data() {
            ...
            var table = $('#datatables-deleted').DataTable({
                ...
                serverSide: true,
                processing: true,
                ajax: "{{ route('admin.product_faq.get_deleted_data', $raw_product_item_id) }}",
                order: [[ 0, 'asc' ]],
                columns: [
                    { data: 'question', name: 'question' },
                    { data: 'answer', name: 'answer' },
