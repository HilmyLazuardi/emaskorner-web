...
@php
    $module             = ucwords(lang('product variant', $translations)) . ' - ' . $header->name;
    $pagetitle          = $module;
            ...
            @if (isset($deleted_data))
                <div class="title_right">
                    <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right">
                        <a href="{{ route('admin.product_variant', $raw_product_item_id) }}" class="btn btn-round btn-primary" style="float: right;">
            ...
            @else
                <div class="title_right">
                    <div class="col-md-7 col-sm-7 col-xs-12 form-group pull-right">
                        <a href="{{ route('admin.product_variant.deleted_data', $raw_product_item_id) }}" class="btn btn-round btn-danger" style="float: right; margin-bottom: 5px;" data-toggle="tooltip" title="{{ ucwords(lang('view deleted items', $translations)) }}">
                            <i class="fa fa-trash"></i>
                        </a>
                        <a href="{{ route('admin.product_variant.create', $raw_product_item_id) }}" class="btn btn-round btn-success" style="float: right;">
                            ...
                            <table id="datatables" class="table table-striped table-bordered dt-responsive" style="display:none">
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ ucwords(lang('weight (in grams)', $translations)) }}</th>
    ...
    <script>
        ...
        function refresh_data() {
            ...
            var table = $('#datatables').DataTable({
                ...
                serverSide: true,
                processing: true,
                ajax: "{{ route('admin.product_variant.get_data', $raw_product_item_id) }}",
                order: [[ 0, 'asc' ]],
                columns: [
                    { data: 'name', name: 'name' },
        ...
        function refresh_deleted_data() {
            ...
            var table = $('#datatables-deleted').DataTable({
                ...
                serverSide: true,
                processing: true,
                ajax: "{{ route('admin.product_variant.get_deleted_data', $raw_product_item_id) }}",
                order: [[ 0, 'asc' ]],
                columns: [
                    { data: 'name', name: 'name' },
                    { data: 'created_at', name: 'created_at' },
