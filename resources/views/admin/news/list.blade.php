...
@php
    $module             = ucwords(lang('news', $translations));
    $pagetitle          = $module;
    ...
    <div class="">
        ...
        <div class="page-title">
            ...
            @if (isset($deleted_data))
                <div class="title_right">
                    <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right">
                        <a href="{{ route('admin.news') }}" class="btn btn-round btn-primary" style="float: right;">
            ...
            @else
                <div class="title_right">
                    <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right">
                        <a href="{{ route('admin.news.deleted_data') }}" class="btn btn-round btn-danger" style="float: right; margin-bottom: 5px;" data-toggle="tooltip" title="{{ ucwords(lang('view deleted items', $translations)) }}">
                            <i class="fa fa-trash"></i>
                        </a>
                        <a href="{{ route('admin.news.create') }}" class="btn btn-round btn-success" style="float: right;">
    ...
    <script>
        ...
        function refresh_data() {
            ...
            var table = $('#datatables').DataTable({
                ...
                serverSide: true,
                processing: true,
                ajax: "{{ route('admin.news.get_data') }}",
                order: [[ 0, 'desc' ]],
                columns: [
                    { data: 'title', name: 'news.title' },
                    { data: 'slug', name: 'news.slug' },
                    { data: 'category_name', name: 'news_categories.name' },
        ...
        function refresh_deleted_data() {
            ...
            var table = $('#datatables-deleted').DataTable({
                ...
                serverSide: true,
                processing: true,
                ajax: "{{ route('admin.news.get_deleted_data') }}",
                order: [[ 0, 'asc' ]],
                columns: [
