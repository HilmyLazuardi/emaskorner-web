...
@php
    $module = ucwords($position) . ' ' . ucwords(lang('banner popup', $translations));
    $pagetitle = $module;
    ...
    <div class="">
        ...
        <div class="page-title">
            ...
            @if (isset($deleted_data))
                <div class="title_right">
                    <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right">
                        <a href="{{ route('admin.banner_popup', $position) }}" class="btn btn-round btn-primary" style="float: right;">
            ...
            @else
                <div class="title_right">
                    <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right">
                        <a href="{{ route('admin.banner_popup.deleted_data', $position) }}" class="btn btn-round btn-danger" style="float: right; margin-bottom: 5px;" data-toggle="tooltip" title="{{ ucwords(lang('view deleted items', $translations)) }}">
                            <i class="fa fa-trash"></i>
                        </a>
                        <a href="{{ route('admin.banner_popup.create', $position) }}" class="btn btn-round btn-success" style="float: right;">
    ...
    <script>
        ...
        function refresh_data() {
            ...
            var table = $('#datatables').DataTable({
                ...
                serverSide: true,
                processing: true,
                ajax: "{{ route('admin.banner_popup.get_data', $position) }}",
                order: [[ 1, 'desc' ]],
                columns: [
                    { data: 'id', name: 'id' },
                    { data: 'published_status', name: 'show_popup',},
                    { data: 'name', name: 'name'},
        ...
        function refresh_deleted_data() {
            ...
            var table = $('#datatables-deleted').DataTable({
                ...
                serverSide: true,
                processing: true,
                ajax: "{{ route('admin.banner_popup.get_deleted_data', $position) }}",
                order: [[ 0, 'asc' ]],
                columns: [
                    { data: 'id', name: 'id' },
                    { data: 'name', name: 'name'},
