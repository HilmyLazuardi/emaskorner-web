...
@php
    $module             = ucwords(lang('product category', $translations));
    $pagetitle          = $module;
    ...
    <div class="">
        ...
        <div class="page-title">
            ...
            @if (isset($deleted_data))
                <div class="title_right">
                    <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right">
                        <a href="{{ route('admin.product_category') }}" class="btn btn-round btn-primary" style="float: right;">
            ...
            @else
                <div class="title_right">
                    <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right">
                        <a href="{{ route('admin.product_category.deleted_data') }}" class="btn btn-round btn-danger" style="float: right; margin-bottom: 5px;" data-toggle="tooltip" title="{{ ucwords(lang('view deleted items', $translations)) }}">
                            <i class="fa fa-trash"></i>
                        </a>
                        
                        <a href="{{ route('admin.product_category.create') }}" class="btn btn-round btn-success" style="float: right;">
...
@section('script')
    ...
    <script>
        var AjaxSortingURL = '{{ route("admin.product_category.sorting") }}';
        ...
        function refresh_data() {
            ...
            $.ajax({
                type: 'GET',
                url: "{{ route('admin.product_category.get_data') }}",
        ...
        function refresh_deleted_data() {
            ...
            var table = $('#datatables-deleted').DataTable({
                ...
                serverSide: true,
                processing: true,
                ajax: "{{ route('admin.product_category.get_deleted_data') }}",
                order: [[ 0, 'asc' ]],
                columns: [
                    { data: 'name', name: 'name' },
                    { data: 'slug', name: 'slug' },
